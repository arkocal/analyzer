...
opam_setup() {
  ...
  # opam switch -y create . --deps-only --packages=ocaml-variants.5.3.0+options,ocaml-option-flambda --locked
  ...
  opam switch -y create . --no-install --packages=ocaml-variants.5.3.0+options,ocaml-option-flambda
